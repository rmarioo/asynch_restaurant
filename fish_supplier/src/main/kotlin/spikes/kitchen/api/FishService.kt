...
class FishService(private val semanticSearchStorage: SemanticSearchStorage,
    ...
    private fun timeToProcess(bakedGood: String) = 2


    companion object {
        private val log = LoggerFactory.getLogger(FishService::class.java)
